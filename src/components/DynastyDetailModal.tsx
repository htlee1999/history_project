      ...
      <DialogContent className="max-w-6xl max-h-[90vh] p-0 bg-white dark:bg-neutral-950 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mb-10">
              <h2 className="text-2xl font-bold text-gray-800 mb-2">Major Historical Events and Legends</h2>
              ...
              <div className="space-y-8">
                {data.events.map((event, index) => (
                  <div key={index} className="border-l-4 border-blue-500 pl-4">
                    ...
                    <div className="mb-4">
                      <h5 className="font-semibold text-gray-800 mb-2">English:</h5>
                      <div 
            ...
            <div>
              ...
              <div className="mb-4">
                <h4 className="font-semibold text-gray-800 mb-2">English:</h4>
